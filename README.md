...
This project implements a modern, decoder-only Transformer language model from scratch, extending the nanoGPT framework. It explores the full lifecycle of Large Language Model (LLM) development, from pretraining on educational data to alignment via Supervised Fine-Tuning (SFT).
...
Pretraining: Trained on ~1B tokens of FineWeb-Edu.

Alignment: Fine-tuned on SmolTalk to enable coherent instruction following.

🙌 Acknowledgements

Andrej Karpathy for the original nanoGPT codebase.
